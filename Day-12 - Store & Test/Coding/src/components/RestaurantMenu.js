...
// import MenuList from "./categoriesHeading";
        ...
        <div className="max-w-2xl mx-auto font-sans mt-4">
                ...
                { 
                    ...
                    offers.map((item) => {
                        return (
                            ...
                            <div key={item?.info?.resId} className="flex align-center justify-start min-w-72  gap-x-2 my-5 py-4  border-2 border-solid shadow-slate-400 rounded-xl">
           ...
           {/* {categoriesHeading ? 
                ...
                <div className="flex max-w-2xl">
                    {categoriesHeading.map((data, item) => {
                        // {data?.itemCards.map()}
            ...
            {categoriesHeading ? 
                ...
                <div>
                    {categoriesHeading.map((data, index) => {
                        ...
                        // Controlled Component
                         <RestaurantCategory 
                            ...
                            item = {data}  
                            showItems = {index === indexVisibility ? true : false}
                            setIndexVisibility = {() => setIndexVisibility(index)}
                         />
